...
gulp.task('watch', function () {
	...
	gulp.watch('src/pdf/**/*').on('all', gulp.parallel('pdf'));
});
...
gulp.task('pdf', function () {
	return gulp.src('src/pdf/**/*').pipe(gulp.dest('dist/pdf')).pipe(browserSync.stream());
});

gulp.task('default', gulp.parallel('watch', 'server', 'styles', 'scripts', 'fonts', 'icons', 'html', 'images', 'pdf'));
